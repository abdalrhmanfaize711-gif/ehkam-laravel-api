...
use App\Http\Requests\Api\DeleteScheduledSardDayRequest;
...
class ScheduledSardDaysController extends Controller
{
    ...
    */
    ...
    public function add_scheduled_sard_day(AddScheduledSardDayRequest $request)
    {
        DB::beginTransaction();
    ...
    */
    ...
    public function get_special_scheduled_sard_day(IdRequest $request)
    {
    ...
    */
    ...
    public function update_scheduled_sard_day(UpdateScheduledSardDayRequest $request)
    {
    ...
    */
    ...
    public function delete_scheduled_sard_day(DeleteScheduledSardDayRequest $request)
    {
