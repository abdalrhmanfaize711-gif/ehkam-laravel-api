...
use App\Http\Requests\Api\AddExamRecordRequest;
use App\Http\Requests\Api\IdRequest;
use App\Http\Requests\Api\UpdateExamRecordRequest;
...
private function checkExamResult($student_id, $percentage, Request $request)
{
    ...
    */
    ...
    public function add_record_exam(AddExamRecordRequest $request)
    {
    ...
    */
    ...
    public function get_special_record_exam(IdRequest $request)
    {
    ...
    */
    ...
    public function update_record_exam(UpdateExamRecordRequest $request)
    {
...
public function surprise_exam_statistics()
{
    ...
    */
     ...
     public function delete_record_exam(IdRequest $request)
    {
        ...
        try {
            ...
            if(!$recordExam){
                ...
                return response()->json([
                    ...
                    'message'=>'لم يتم العثور على سجل السرد'
            ...
            return response()->json([
                ...
                'message'=>'تم حذف سجل السرد بنجاح'
