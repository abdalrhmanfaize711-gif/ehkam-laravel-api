...
use App\Http\Requests\Api\AddTasshehRecordRequest;
use App\Http\Requests\Api\UpdateTasshehRecordRequest;
...
class TasshehRecoredController extends Controller
{
    ...
    */
    ...
    public function add_tassheh_record(AddTasshehRecordRequest $request)
    {
    ...
    */
    ...
    public function update_tassheh_record(UpdateTasshehRecordRequest $request)
    {
        $request->validate([
    ...
    */
    ...
    public function delete_tassheh_record(IdRequest $request)
    {
        $request->validate([
    ...
    */
    ...
    public function get_special_tassheh_record(IdRequest $request)
    {
