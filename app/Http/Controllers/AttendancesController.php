...
class AttendancesController extends Controller
{
    ...
    public function getAbsentStudentByDate(Request $request)
    {
        $request->validate([
            'date' => 'required|date',
        ]);
    ...
    public function addLateAttendance(Request $request)
    {
        DB::beginTransaction();
    ...
    public function add_attendances(Request $request)
    {
        DB::beginTransaction();
    ...
    public function get_all_attendances(Request $request)
    {
        $attendances = AttendancesModel::all();
    ...
    public function getAbsentStudentsByDate(Request $request)
    {
        $request->validate([
