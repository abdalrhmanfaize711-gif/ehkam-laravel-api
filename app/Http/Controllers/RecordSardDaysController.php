...
class RecordSardDaysController extends Controller
{
    ...
    */
    ...
    public function add_record_sard_day(Request $request)
    {
        $request->validate([
            'student_id' => 'required|exists:students,id',
            'num_of_session' => 'required|integer|min:1',
            'sard_day' => 'required|string',
            'num_of_remaining_sheets' => 'required|integer|min:0',
        ]);
...
$record = RecordSardDaysModel::create([
    ...
    */
    ...
    public function get_special_record_sard_day(Request $request)
    {
    ...
    */
    ...
    public function update_record_sard_day(Request $request)
    {
        DB::beginTransaction();
    ...
    */
    ...
    public function delete_record_sard_day(Request $request)
    {
        DB::beginTransaction();
