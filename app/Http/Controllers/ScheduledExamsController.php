...
class ScheduledExamsController extends Controller
{
    ...
    public function add_scheduled_exam(Request $request)
    {
        DB::beginTransaction();
    ...
    public function get_special_scheduled_exams(Request $request)
    {
    ...
    public function update_scheduled_exams(Request $request)
    {
    ...
    public function delete_scheduled_exams(Request $request)
    {
