...
class SardSessionsRecordController extends Controller
{
    ...
    */
    ...
    public function add_sard_session_record(Request $request)
    {
        DB::beginTransaction();
    ...
    */
    ...
    public function get_special_sard_session_record(Request $request)
    {
    ...
    */
    ...
    public function update_sard_session_record(Request $request)
    {
 ...
 'student_id' => $request->student_id,
    ...
    */
    ...
    public function delete_sard_session_record(Request $request)
    {
