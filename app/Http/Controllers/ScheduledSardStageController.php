...
class ScheduledSardStageController extends Controller
{
    ...
    */
    ...
    public function add_scheduled_sard_stage(Request $request)
    {
        DB::beginTransaction();
    ...
    */
    ...
    public function get_special_scheduled_sard_stage(Request $request)
    {
    ...
    */
    ...
    public function update_scheduled_sard_stage(Request $request)
    {
    ...
    */
    ...
    public function delete_scheduled_sard_stage(Request $request)
    {
